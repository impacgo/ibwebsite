...
// import 'package:flutter_svg/flutter_svg.dart'; // Import the SVG library
...
//           style: TextStyle(
//             color: controller.text.isNotEmpty ? Colors.black54 : Colors.red,
//           ),
//         ),
...
//   // Corrected function to return the SVG asset path
...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Widget _buildSlotTile(
    ...
    } else if (isCollect && _collectDate != null) {
  ...
  Future<void> _selectDate(BuildContext context, bool isCollect) async {
    ...
    if (picked != null) {
      ...
      if (isCollect) {
        _selectTimeSlot(context, picked);
      } else {
        // Drop-off should be at least one day after pick-up
  ...
  void _selectTimeSlot(BuildContext context, DateTime selectedDate) {
    final now = DateTime.now();
    final isToday = selectedDate.year == now.year && selectedDate.month == now.month && selectedDate.day == now.day;

    final List<String> availableSlots = _generateTimeSlots(selectedDate);
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: ActionChip(
                        label: Text(slot),
                        backgroundColor: _selectedCollectTimeSlot == slot ? Colors.green.shade100 : Colors.grey.shade200,
                        onPressed: () {
                          setState(() {
