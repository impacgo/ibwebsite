...
//             children: [
//               SvgPicture.asset('assets/images/Gift.svg',height: 100,width: 100, fit: BoxFit.contain, color: Colors.white,),
      ...
      children: [
        Container(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              // Gift Icon inside circular background so it's always visible
              Container(
                padding: const EdgeInsets.all(16),
                decoration: const BoxDecoration(
                ...
                child: SvgPicture.asset(
                  ...
                  width: 80,
                  color: Colors.green, 
                  fit:BoxFit.contain,// make the gift stand out
                ),
              ),
              const SizedBox(height: 20),
...
class EarnTab extends StatelessWidget {
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 15),
          referralTile("Aditya Ram", "Pending", "Apr 20", 100.00, Colors.orange),
          referralTile("Sai", "Successful", "Apr 8", 100.00, Colors.green),
          referralTile(
              "Bhushan Gonthina", "Successful", "Mar 7", 100.00, Colors.green),
        ],
  ...
  static Widget referralTile(
      String name, String status, String date, double amount, Color statusColor) {
    return Card(
      margin: const EdgeInsets.symmetric(vertical: 8),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
      child: ListTile(
